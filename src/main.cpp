...
const char* menu_items[] = {
    ...
    " Parameter 8:",
    " Parameter 9:",
    // Добавьте остальные 16 элементов
};
// --------------------------------------------------------------
// битмапы
...
void clickSound() {
  if(sound_enabled == true) {
    for (int i=400; i<6000; i=i*1.5) { tone(SOUND_PIN, i); delay(20); }
    noTone(SOUND_PIN);
  }
...
bool draw_logo() {
  ...
  tone(SOUND_PIN, NOTE_A7); delay(100);
  tone(SOUND_PIN, NOTE_G7); delay(100);
  tone(SOUND_PIN, NOTE_E7); delay(100); 
  tone(SOUND_PIN, NOTE_C7); delay(100);  
  tone(SOUND_PIN, NOTE_D7); delay(100); 
  tone(SOUND_PIN, NOTE_B7); delay(100); 
  tone(SOUND_PIN, NOTE_F7); delay(100); 
  tone(SOUND_PIN, NOTE_C7); delay(100);
  noTone(SOUND_PIN); 
  delay(2000);
  oled.clear();
